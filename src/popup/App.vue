<template>
  <div class="app h-screen flex" :class="[theme.bg]">
    ...
    <div v-show="currentTab == 'home'" class="flex-grow flex-col justify-around">
      <div class="text-center">
        ...
        <div class="text-2xl mb-2 font-regular" :class="[theme.text]">Chameleon is {{ config.enabled ? 'enabled' : 'disabled' }}</div>
