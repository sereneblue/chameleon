<script>
  let settings = {
    casual: `{"config":{"enabled":true,"notificationsEnabled":false,"theme":"light"},"excluded":[],"headers":{"blockEtag":true,"enableDNT":false,"referer":{"disabled":false,"xorigin":1,"trimming":1},"spoofAcceptLang":{"enabled":false,"value":"default"},"spoofIP":{"enabled":false,"option":0,"rangeFrom":"","rangeTo":""}},"ipRules":[],"options":{"cookiePolicy":"reject_trackers","disableWebRTC":false,"firstPartyIsolate":true,"limitHistory":true,"protectKBFingerprint":{"enabled":false,"delay":1},"protectWinName":true,"resistFingerprinting":false,"screenSize":"default","spoofAudioContext":false,"spoofClientRects":false,"timeZone":"default","trackingProtectionMode":"always","webRTCPolicy":"default_public_interface_only","webSockets":"allow_all"},"profile":{"selected":"randomDesktop","interval":{"option":10,"min":1,"max":1}},"version":"0.20.0.3","whitelist":{"enabledContextMenu":true,"defaultProfile":"none","rules":[]}}`,
    advanced: `{"config":{"enabled":true,"notificationsEnabled":false,"theme":"light"},"excluded":[],"headers":{"blockEtag":true,"enableDNT":false,"referer":{"disabled":false,"xorigin":1,"trimming":1},"spoofAcceptLang":{"enabled":false,"value":"default"},"spoofIP":{"enabled":false,"option":0,"rangeFrom":"","rangeTo":""}},"ipRules":[],"options":{"cookiePolicy":"reject_third_party","disableWebRTC":false,"firstPartyIsolate":true,"limitHistory":true,"protectKBFingerprint":{"enabled":false,"delay":1},"protectWinName":true,"resistFingerprinting":true,"screenSize":"profile","spoofAudioContext":true,"spoofClientRects":true,"timeZone":"default","trackingProtectionMode":"always","webRTCPolicy":"default_public_interface_only","webSockets":"block_3rd_party"},"profile":{"selected":"randomDesktop","interval":{"option":10,"min":1,"max":1}},"version":"0.20.0.3","whitelist":{"enabledContextMenu":true,"defaultProfile":"none","rules":[]}}`
  };
    ...
    <div class="mb-4">
      <div class="mt-4">
        ...
        <div class="flex flex-col justify-around mb-4">
          <a class="mx-0 bg-white shadow hover:text-primary hover:shadow-lg px-6 py-4 rounded mb-3" href="wiki/profile">
            <span class="font-semibold text-2xl">Profile</span>
            <p class="text-lg mt-1">Learn more about the features on the Profile tab</p>
          </a>
          <a class="mx-0 bg-white shadow hover:text-primary hover:shadow-lg px-6 py-4 rounded mb-3" href="wiki/headers">
          ...
          <a class="mx-0 bg-white shadow hover:text-primary hover:shadow-lg px-6 py-4 rounded mb-3" href="wiki/whitelist">
        ...
        <div class="text-lg mb-4 w-full flex justify-center">
          <img src="dashboard.png" alt="Chameleon IP Rules">
        </div>
        <p class="py-2">
