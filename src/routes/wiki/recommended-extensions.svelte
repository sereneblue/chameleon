<svelte:head>
	<title>Recommended Extensions | Chameleon</title>
</svelte:head>

<div class="mb-8 px-4 text-xl leading-tight">
  <div class="mb-4">
    Listed below are addons that you should use in addition to Chameleon.
  </div>
  <div>
    <div class="flex items-center mb-4">
      ...
      <div>
        ...
        Block ads and various trackers.
      </div>
    </div>
    <div class="flex items-center mb-4">
    ...
    <div class="flex items-center mb-4">
      ...
      <div>
        ...
        Disposable containers that act similar to a private browsing tab.
      </div>
    </div>
  </div>
</div>