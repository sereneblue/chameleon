			...
			<div class="w-full lg:max-w-md">
				...
				<div class="w-full flex justify-center lg:justify-start">
					{#if !isNewInstall}
						...
						{/if}
					{/if}
					<button on:click={ e => goto('about') } class="flex items-center bg-transparent hover:bg-primary text-primary hover:text-white font-bold py-2 px-4 text-xl rounded shadow-md border border-primary hover:border-transparent">
						Learn more
					</button>
				</div>
			</div>
